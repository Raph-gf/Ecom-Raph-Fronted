...
function Homepage() {
  ...
  return (
    <>
      ...
      <section className="First-section flex flex-row gap-10 justify-center mb-40 w-screen px-10 mt-20">
        <div className="text-section w-full">
          <h3>Find our latest products</h3>
          <h1 className="title text-8xl w-full mb-8 mt-4 font-bold">
      ...
      <section className="Second-section px-10 w-screen mb-40">
        <h1 className="Popular-Product text-7xl mb-7">
      ...
      <section className="Thrid-section">
        <div className="under-section flex flex-row gap-10 justify-center items-center mb-40 w-screen px-10 mt-40">
          <div className="text">
            <h1 className="title text-7xl mb-7">
              We Provide You{" "}
      ...
      <section className="Fifth-section px-10 w-screen mt-40 mb-40">
        <div className="under-section flex items-center gap-20 ">
